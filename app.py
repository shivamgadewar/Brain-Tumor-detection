...
# Corrected model and dataset paths
BASE_DIR = r"C:\Users\shivay\Desktop\Final_project_file\brain_tumor_detection-master"
MODEL_DIR = os.path.join(BASE_DIR, "models")
VALIDATION_DIR = os.path.join(BASE_DIR, "validation")

detection_model_path = os.path.join(MODEL_DIR, "Detection_Model.keras")
classification_model_path = os.path.join(MODEL_DIR, "tumor_classification_model.keras")
...
# Load validation dataset features
validation_images = [os.path.join(VALIDATION_DIR, filename) for filename in os.listdir(VALIDATION_DIR)]
dataset_features = [extract_features(img_path) for img_path in validation_images]
